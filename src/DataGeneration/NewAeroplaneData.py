...
def generate_second_file_data(common_aircraft_id):
    data = {
        "aircraft_id": random.randint(1, 1000),
        "aircraft_rating": random.choice([round(random.uniform(1, 10), 2) if i != 0 else 0 for i in range(11)]),
        "price": {
...
if __name__ == "__main__":
    try:
        ...
        with open("FirstAeroplaneJSON.json", "a") as json_file:
        ...
        with open("SecondAeroplaneJSON.json", "a") as json_file:
